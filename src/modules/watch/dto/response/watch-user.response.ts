...
export class WatchUserResponse  extends UserResponse{
    ...
    @Expose()
    @Transform(( value ) => value.obj.school?{id: value.obj.school.id,stage:value.obj.grade.name, name: value.obj.school.name, avatar: toUrl(value.obj.school.avatar)}:null)
    school: School;
    @Expose()
